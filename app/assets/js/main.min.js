...
$(document).ready(function () {
  ...
  $('.shopping-cart__body').on('click', 'button.button', function (event) {
    ...
    $button.parent().parent().find('.shopping-cart__item__item-total').html(newVal * price); // TODO: 1. Add amount updates - 2. abstract away in function

    $('.amount').html(price);
    $('.subtitle').html(price);
    $('.subtitle-amount').html(price); // TODO: Add discount calling logic
  ...
  $('button.button--primary').on('click', function (event) {
    ...
    $('input').val(0); // TODO: Add summary resets here
  }); // CHECKOUT RESET
